...
# Set up English dictionary (pyenchant)
...
def semantic_clarity(identifier):
    ...
    def token_score(token):
        # Check in either dictionary or wordfreq high frequency
...
# Save to new CSV
df.to_csv("consolidated_identifiers_with_SC.csv", index=False)
print("Done. Output saved as consolidated_identifiers_with_SC.csv")
